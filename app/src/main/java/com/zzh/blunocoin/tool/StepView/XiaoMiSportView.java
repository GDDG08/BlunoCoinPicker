package com.zzh.blunocoin.tool.StepView;
...
//       消耗的文字显示
        ...
        String content2 = "硬币总金额";/*SportUtils.getKilometresByStepNumber(0, 1.75, currentNum) + "米 | " + SportUtils.getCalorieBySex(0, 64, currentNum) + "千卡";*/
