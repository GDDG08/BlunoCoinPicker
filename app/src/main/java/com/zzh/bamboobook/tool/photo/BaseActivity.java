package com.zzh.bamboobook.tool.photo;
...
public abstract class BaseActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		mContext = this;
        ZZHApplication.getInstance().mActivityStack.addActivity(this);
	...
	public void finish() {
		super.finish();
		ZZHApplication.getInstance().mActivityStack.removeActivity(this);
	}
