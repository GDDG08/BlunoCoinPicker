...
public class SunBabyLoadingView extends View {
     ...
     * 画笔的颜色
     */
    private static final String PAINT_COLOR = "#FDD835";

    /**
     * 背景色
     */
    private static final String BG_COLOR = "#FFFFFF";//"#26A69A";
    ...
    private ValueAnimator initRise2SlowAnimator() {
        ...
        rise2SlowAnima.setDuration(1500);
    ...
    private ValueAnimator initTurnEyesLeftAnimator() {
        ...
        turnEyesLeftAnima.setStartDelay(400);
        turnEyesLeftAnima.setDuration(75);
    ...
    private ValueAnimator initBlink1Animator() {
        ...
        blink1Anima.setStartDelay(300);
        blink1Anima.setDuration(50);
    ...
    private ValueAnimator initTurnEyesRightAnimator() {
        ...
        turnEyesRightAnima.setStartDelay(100);
        turnEyesRightAnima.setDuration(75);
    ...
    private ValueAnimator initBlink2Animator() {
        ...
        blink2Anima.setStartDelay(200);
        blink2Anima.setDuration(250);
    ...
    private ValueAnimator initRise1Animator() {
        ...
        rise1SlowAnima.setDuration(1250);
    ...
    private void drawUnderLineView(Canvas canvas) {
        ...
        canvas.drawText("加载中哟～哇咔咔", textX, textY, mTextPaint);
        canvas.restore();
    }
